...
public class Defenders {
    ...
    public static void setupTeam() {
        team = TowerAttackDefence.board.getTeam(TEAM_DEFENDER);
        if (team == null) {
            team = TowerAttackDefence.board.registerNewTeam(TEAM_DEFENDER);
            team.setPrefix(ChatColor.AQUA + "[Defender] " + ChatColor.WHITE);
            team.setSuffix(ChatColor.RESET.toString());
            team.setDisplayName(ChatColor.AQUA + "Defender");
